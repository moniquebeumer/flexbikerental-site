      ...
      <main style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <Section title="3. Waarom verwerken wij uw gegevens?">
          ...
          <ul>
            ...
            <li><strong>Identiteitscontrole</strong> — zodat wij zeker weten met wie wij de huurovereenkomst sluiten (gerechtvaardigd belang); u kiest zelf of dat online via Veriff of op locatie gebeurt</li>
